<template>
  <div
    ...
    :class="theme"
  >
    <header class="border-t-14 border-blue-full">
    ...
    <footer class="bg-blue-full text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>
            © 2017-2019 | Design by
            <a
              href="https://cecilemoret.com/"
              target="_blank"
              class="text-white hover:text-gray-400"
            >Cécile Moret</a>
            | Code by
            <a
              href="http://julientanay.com/"
              target="_blank"
              class="text-white hover:text-gray-400"
            >Julien Tanay</a>
            <br />
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a
              href="https://github.com/wikiwarsgg/website"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
          ...
          <li class="mr-8">
            <a
              href="https://twitter.com/wikiwarsgg"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
          ...
          <li class="mr-8">
            <a
              href="https://facebook.com/wikiwarsgg"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
          ...
          <li class="mr-8">
            <a
              href="https://instagram.com/wikiwarsgg"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
